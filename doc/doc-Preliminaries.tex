%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FILE   : doc-Preliminaries.tex
% SUBJECT: How to get set up for GenericFS development.
...
You can use the \command{fdisk} command to create a partition on a physical disk or on a virtual
...
device files for the new disk and its partitions in the \filename{/dev} directory.
...
To set up an image file, first create a file of some suitable size using the \command{dd}
...
manipulate the partition directly, for example with \command{disktool}.
