...
% and several suggestions for such experiments are given in exercises. It is my hope that
% eventually this document will become a comprehensive guide to building file systems in Linux
% and to file system design issues in general.
%
% This document is very much a work in progress. Currently only a small fraction is done, and
% many errors and inconsistencies likely exist.
%
% TODO:
%
